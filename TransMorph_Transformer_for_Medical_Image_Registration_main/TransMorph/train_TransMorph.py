...
def main():
    ...
    train_dir = r'D:\datasets\train_val_test\test_ori__'
    ...
    val_dir = r'D:\datasets\train_val_test\test_ori_2'
    ...
    for epoch in range(epoch_start, max_epoch):
        ...
        for batch, (moving, fixed) in enumerate(train_loader):
            ...
            sys.stdout.write(
                "\r" + 'epoch:"{0}"step:batch "{1}:{2}" -> training loss "{3:.6f}" - sim "{4:.6f}"  -reg "{5:.6f}"\n'.format(
